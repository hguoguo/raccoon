        ...
        chapters: [
          {
            ...
            articles: [
              ...
              { slug: 'unsafe-class', title: 'Unsafe魔法类底层操作', meta: { id: 'unsafe-class', title: 'Unsafe魔法类底层操作', level: 'Expert', tags: ['Unsafe', 'CAS', '内存操作', '直接内存', '原子操作', '锁机制'], difficulty: 5, category: '01-java-core', prerequisites: ['reflection'], relatedPatterns: ['atomic-operations', 'jvm-memory-model'], readingTime: 55 } },
              { slug: 'spi-mechanism', title: 'SPI服务发现机制', meta: { id: 'spi-mechanism', title: 'SPI服务发现机制', level: 'Senior', tags: ['SPI', 'ServiceLoader', '服务发现', '插件化', '扩展点', 'Dubbo SPI'], difficulty: 3, category: '01-java-core', prerequisites: ['reflection'], relatedPatterns: ['design-pattern-intro', 'spring-boot'], readingTime: 40 } },
              { slug: 'syntax-sugar', title: 'Java语法糖揭秘', meta: { id: 'syntax-sugar', title: 'Java语法糖揭秘', level: 'Senior', tags: ['语法糖', '反编译', '自动装箱', '增强for循环', 'switch字符串', 'try-with-resources'], difficulty: 3, category: '01-java-core', prerequisites: ['java-basics'], relatedPatterns: ['generic-enum', 'lambda-expressions'], readingTime: 45 } },
              { slug: 'pass-by-value', title: '值传递vs引用传递辨析', meta: { id: 'pass-by-value', title: '值传递vs引用传递辨析', level: 'Junior', tags: ['值传递', '引用传递', '参数传递', '对象引用', '内存模型'], difficulty: 2, category: '01-java-core', prerequisites: ['java-basics'], relatedPatterns: ['jvm-memory-model'], readingTime: 35 } },
    ...
    subCategories: [
      {
        ...
        chapters: [
          ...
          },
          {
            ...
            color: 'blue',
            articles: [
              { slug: 'mysql-architecture', title: 'MySQL架构与存储引擎', meta: { id: 'mysql-architecture', title: 'MySQL架构与存储引擎', level: 'Expert', tags: ['MySQL', 'InnoDB', 'MyISAM', '架构设计', '缓冲池', '日志系统', 'MVCC'], difficulty: 4, category: 'mysql', prerequisites: ['sql-optimization'], relatedPatterns: ['postgresql', 'database-internals'], readingTime: 60 } },
              { slug: 'mysql-index-optimization', title: 'MySQL索引优化实战', meta: { id: 'mysql-index-optimization', title: 'MySQL索引优化实战', level: 'Expert', tags: ['B+树', '聚簇索引', '覆盖索引', '最左前缀', '索引下推', 'ICP'], difficulty: 5, category: 'mysql', prerequisites: ['sql-optimization'], relatedPatterns: ['query-optimization', 'performance-tuning'], readingTime: 65 } },
              { slug: 'mysql-transaction-lock', title: 'MySQL事务与锁机制', meta: { id: 'mysql-transaction-lock', title: 'MySQL事务与锁机制', level: 'Expert', tags: ['ACID', '隔离级别', '行锁', '表锁', '间隙锁', '死锁', 'MVCC', 'Undo Log'], difficulty: 5, category: 'mysql', prerequisites: ['mysql-architecture'], relatedPatterns: ['concurrency-control', 'distributed-transaction'], readingTime: 70 } },
              { slug: 'mysql-replication-ha', title: 'MySQL主从复制与高可用', meta: { id: 'mysql-replication-ha', title: 'MySQL主从复制与高可用', level: 'Expert', tags: ['主从复制', 'Binlog', 'GTID', 'MHA', 'Orchestrator', '读写分离', '分库分表'], difficulty: 5, category: 'mysql', prerequisites: ['mysql-architecture'], relatedPatterns: ['high-availability', 'sharding'], readingTime: 65 } },
              { slug: 'mysql-performance-tuning', title: 'MySQL性能调优', meta: { id: 'mysql-performance-tuning', title: 'MySQL性能调优', level: 'Expert', tags: ['慢查询', '执行计划', '参数调优', '连接池', '缓冲池配置', '监控工具'], difficulty: 5, category: 'mysql', prerequisites: ['mysql-index-optimization'], relatedPatterns: ['sql-optimization', 'observability-monitoring'], readingTime: 60 } },
            ],
          },
          {
            id: 'postgresql',
            ...
            color: 'blue',
            articles: [
              { slug: 'postgresql-core', title: 'PostgreSQL核心原理', meta: { id: 'postgresql-core', title: 'PostgreSQL核心原理', level: 'Expert', tags: ['PostgreSQL', 'MVCC', 'WAL', 'VACUUM', 'TOAST', '多版本并发控制'], difficulty: 4, category: 'postgresql', prerequisites: ['sql-optimization'], relatedPatterns: ['mysql-architecture', 'database-internals'], readingTime: 60 } },
              { slug: 'postgresql-jsonb', title: 'PostgreSQL JSONB与NoSQL能力', meta: { id: 'postgresql-jsonb', title: 'PostgreSQL JSONB与NoSQL能力', level: 'Senior', tags: ['JSONB', 'GIN索引', '文档存储', '半结构化数据', '查询优化'], difficulty: 4, category: 'postgresql', prerequisites: ['postgresql-core'], relatedPatterns: ['nosql', 'elasticsearch'], readingTime: 50 } },
              { slug: 'postgresql-extensions', title: 'PostgreSQL扩展生态', meta: { id: 'postgresql-extensions', title: 'PostgreSQL扩展生态', level: 'Senior', tags: ['PostGIS', 'pgvector', 'TimescaleDB', 'Citus', '插件开发', 'FDW'], difficulty: 4, category: 'postgresql', prerequisites: ['postgresql-core'], relatedPatterns: ['gis', 'vector-database', 'time-series'], readingTime: 55 } },
              { slug: 'postgresql-replication', title: 'PostgreSQL高可用与复制', meta: { id: 'postgresql-replication', title: 'PostgreSQL高可用与复制', level: 'Expert', tags: ['流复制', '逻辑复制', 'Patroni', 'Pgpool-II', '负载均衡', '故障切换'], difficulty: 5, category: 'postgresql', prerequisites: ['postgresql-core'], relatedPatterns: ['high-availability', 'mysql-replication-ha'], readingTime: 60 } },
            ],
          },
          {
            id: 'tidb',
            title: 'TiDB分布式HTAP数据库',
            icon: '🔶',
            description: 'TiDB NewSQL数据库、HTAP架构、水平扩展',
            difficulty: 5,
            color: 'blue',
            articles: [
              { slug: 'tidb-architecture', title: 'TiDB分布式HTAP数据库', meta: { id: 'tidb-architecture', title: 'TiDB分布式HTAP数据库', level: 'Expert', tags: ['TiDB', 'HTAP', '分布式数据库', 'TiKV', 'TiFlash', 'NewSQL', 'MySQL兼容', '水平扩展'], difficulty: 5, category: 'tidb', prerequisites: ['mysql-architecture'], relatedPatterns: ['distributed-systems', 'high-availability', 'clickhouse-architecture'], readingTime: 70 } },
              { slug: 'tidb-optimization', title: 'TiDB性能调优与实践', meta: { id: 'tidb-optimization', title: 'TiDB性能调优与实践', level: 'Expert', tags: ['TiDB', '执行计划', '索引优化', '统计信息', 'Region分裂', 'PD调度', 'TiFlash加速'], difficulty: 5, category: 'tidb', prerequisites: ['tidb-architecture'], relatedPatterns: ['performance-tuning', 'sql-optimization'], readingTime: 65 } },
              { slug: 'tidb-vs-mysql', title: 'TiDB vs MySQL：选型与迁移指南', meta: { id: 'tidb-vs-mysql', title: 'TiDB vs MySQL：选型与迁移指南', level: 'Expert', tags: ['TiDB', 'MySQL', '技术选型', '数据库迁移', '分布式', '兼容性', '场景对比'], difficulty: 4, category: 'tidb', prerequisites: ['tidb-architecture', 'mysql-architecture'], relatedPatterns: ['database-comparison', 'high-availability'], readingTime: 60 } },
            ],
          },
          {
      ...
      },
      {
        ...
        icon: '📦',
        domainId: 'infra',
        description: 'Redis、Elasticsearch、MongoDB等非关系型数据库',
        chapters: [
          {
            id: 'redis',
            title: 'Redis',
          ...
          },
          {
            ...
            title: 'Elasticsearch',
            icon: '🔍',
            description: '分布式搜索引擎与文档型NoSQL数据库，支持全文检索、聚合分析',
            difficulty: 4,
            color: 'blue',
            articles: [
              { slug: 'elasticsearch', title: 'Elasticsearch搜索引擎', meta: { id: 'elasticsearch', title: 'Elasticsearch搜索引擎', level: 'Senior', tags: ['Elasticsearch', '全文检索', '倒排索引', 'Lucene', '聚合查询', 'ELK'], difficulty: 4, category: 'elasticsearch', prerequisites: [], relatedPatterns: ['vector-database', 'semantic-search-optimization'], readingTime: 60 } },
            ],
          },
        ],
      },
      {
        ...
        icon: '📊',
        domainId: 'infra',
        description: 'ClickHouse等列式分析数据库，用于实时分析与海量数据处理',
        chapters: [
          {
            id: 'clickhouse',
            title: 'ClickHouse数据库',
            icon: '⚡',
            description: 'ClickHouse列式存储、向量化执行、分布式集群',
            difficulty: 5,
            color: 'orange',
            articles: [
              { slug: 'clickhouse-architecture', title: 'ClickHouse架构与原理', meta: { id: 'clickhouse-architecture', title: 'ClickHouse架构与原理', level: 'Expert', tags: ['列式存储', '向量化执行', '稀疏索引', '数据压缩', 'MergeTree', 'LSM-Tree'], difficulty: 5, category: 'clickhouse', prerequisites: [], relatedPatterns: ['olap', 'bigdata-ecosystem'], readingTime: 65 } },
              { slug: 'clickhouse-performance', title: 'ClickHouse性能优化', meta: { id: 'clickhouse-performance', title: 'ClickHouse性能优化', level: 'Expert', tags: ['分区键', '排序键', '采样', '物化视图', '预聚合', '查询优化'], difficulty: 5, category: 'clickhouse', prerequisites: ['clickhouse-architecture'], relatedPatterns: ['performance-tuning', 'realtime-data-warehouse'], readingTime: 60 } },
              { slug: 'clickhouse-distributed', title: 'ClickHouse分布式集群', meta: { id: 'clickhouse-distributed', title: 'ClickHouse分布式集群', level: 'Expert', tags: ['分片', '副本', 'ZooKeeper', '分布式表', '全局字典', '负载均衡'], difficulty: 5, category: 'clickhouse', prerequisites: ['clickhouse-architecture'], relatedPatterns: ['distributed-systems', 'high-availability'], readingTime: 65 } },
            ],
          },
          {
            id: 'olap-comparison',
            title: 'OLAP数据库选型与对比',
            icon: '⚖️',
            description: '主流OLAP数据库的横向对比、选型指南与场景分析',
            difficulty: 5,
            color: 'blue',
            articles: [
              { slug: 'olap-database-comparison', title: 'OLAP数据库选型与对比', meta: { id: 'olap-database-comparison', title: 'OLAP数据库选型与对比', level: 'Expert', tags: ['ClickHouse', 'Doris', 'Presto', 'Druid', '技术选型', '性能对比', '适用场景', '架构差异', '成本分析'], difficulty: 5, category: 'olap-comparison', prerequisites: ['clickhouse-architecture'], relatedPatterns: ['database-comparison', 'realtime-data-warehouse', 'bigdata-ecosystem'], readingTime: 70 } },
            ],
          },
        ],
      },
        ...
        chapters: [
          {
            ...
            color: 'blue',
            articles: [
              { slug: 'flink-streaming', title: 'Flink实时计算框架', meta: { id: 'flink-streaming', title: 'Flink实时计算框架', level: 'Expert', tags: ['Flink', '流处理', 'DataStream API', 'Checkpoint', '状态管理', '窗口', 'Watermark'], difficulty: 5, category: 'bigdata-ecosystem', prerequisites: ['java-basics', 'multi-threading-basics'], relatedPatterns: ['spark-computing', 'kafka'], readingTime: 70 } },
              { slug: 'spark-computing', title: 'Spark分布式计算', meta: { id: 'spark-computing', title: 'Spark分布式计算', level: 'Expert', tags: ['Spark', 'RDD', 'DataFrame', 'Spark SQL', 'MLlib', 'GraphX', '分布式计算'], difficulty: 5, category: 'bigdata-ecosystem', prerequisites: ['java-basics', 'python-basics'], relatedPatterns: ['flink-streaming', 'hadoop-ecosystem'], readingTime: 65 } },
              { slug: 'hadoop-ecosystem', title: 'Hadoop生态系统', meta: { id: 'hadoop-ecosystem', title: 'Hadoop生态系统', level: 'Senior', tags: ['Hadoop', 'MapReduce', 'YARN', 'HDFS', '生态圈', '大数据平台'], difficulty: 4, category: 'bigdata-ecosystem', prerequisites: ['java-basics'], relatedPatterns: ['hdfs', 'hive-data-warehouse'], readingTime: 60 } },
              { slug: 'hive-data-warehouse', title: 'Hive数据仓库', meta: { id: 'hive-data-warehouse', title: 'Hive数据仓库', level: 'Senior', tags: ['Hive', 'HQL', '数据仓库', '分区表', '分桶表', 'UDF', '优化'], difficulty: 4, category: 'bigdata-ecosystem', prerequisites: ['sql-optimization'], relatedPatterns: ['hadoop-ecosystem', 'elasticsearch'], readingTime: 55 } },
              { slug: 'hdfs', title: 'HDFS分布式文件系统', meta: { id: 'hdfs', title: 'HDFS分布式文件系统', level: 'Senior', tags: ['HDFS', 'NameNode', 'DataNode', '副本机制', '块存储', '高可用'], difficulty: 4, category: 'bigdata-ecosystem', prerequisites: ['hadoop-ecosystem'], relatedPatterns: ['distributed-systems', 'storage'], readingTime: 50 } },
              { slug: 'realtime-data-warehouse', title: '实时数仓架构设计', meta: { id: 'realtime-data-warehouse', title: '实时数仓架构设计', level: 'Expert', tags: ['实时数仓', 'Lambda架构', 'Kappa架构', '流批一体', '数据湖', 'Iceberg'], difficulty: 5, category: 'bigdata-ecosystem', prerequisites: ['flink-streaming', 'hive-data-warehouse'], relatedPatterns: ['stream-batch-unified', 'data-lake'], readingTime: 70 } },
              { slug: 'stream-batch-unified', title: '流批一体处理', meta: { id: 'stream-batch-unified', title: '流批一体处理', level: 'Expert', tags: ['流批一体', '统一API', 'Flink SQL', '数据一致性', 'Exactly-Once'], difficulty: 5, category: 'bigdata-ecosystem', prerequisites: ['flink-streaming', 'spark-computing'], relatedPatterns: ['realtime-data-warehouse', 'data-pipeline'], readingTime: 65 } },
            ],
          },
        ],
      },
      {
        ...
        icon: '📨',
        domainId: 'infra',
        description: 'Kafka、RocketMQ、RabbitMQ等消息中间件与通信模式',
        chapters: [
          {
            id: 'kafka',
            title: 'Kafka消息队列',
            ...
            color: 'rose',
            articles: [
              { slug: 'kafka-architecture', title: 'Kafka架构与核心概念', meta: { id: 'kafka-architecture', title: 'Kafka架构与核心概念', level: 'Expert', tags: ['Kafka', 'Broker', 'Topic', 'Partition', 'Consumer Group', 'ZooKeeper', 'KRaft'], difficulty: 4, category: 'kafka', prerequisites: [], relatedPatterns: ['distributed-systems', 'message-queue'], readingTime: 60 } },
              { slug: 'kafka-producer-consumer', title: 'Kafka生产者与消费者', meta: { id: 'kafka-producer-consumer', title: 'Kafka生产者与消费者', level: 'Expert', tags: ['Producer', 'Consumer', '序列化', '分区策略', '位移提交', '重平衡'], difficulty: 4, category: 'kafka', prerequisites: ['kafka-architecture'], relatedPatterns: ['message-reliability', 'performance-tuning'], readingTime: 65 } },
              { slug: 'kafka-reliability', title: 'Kafka消息可靠性保证', meta: { id: 'kafka-reliability', title: 'Kafka消息可靠性保证', level: 'Expert', tags: ['ACK机制', 'ISR', '副本同步', '事务', '幂等性', 'Exactly-Once', '消息丢失'], difficulty: 5, category: 'kafka', prerequisites: ['kafka-architecture'], relatedPatterns: ['distributed-transaction', 'message-queue'], readingTime: 70 } },
              { slug: 'kafka-streams', title: 'Kafka Streams流处理', meta: { id: 'kafka-streams', title: 'Kafka Streams流处理', level: 'Expert', tags: ['Kafka Streams', 'Stream Processing', 'KTable', 'Window', 'Join', '状态存储'], difficulty: 5, category: 'kafka', prerequisites: ['kafka-architecture'], relatedPatterns: ['flink-streaming', 'stream-batch-unified'], readingTime: 65 } },
              { slug: 'kafka-performance-tuning', title: 'Kafka性能调优', meta: { id: 'kafka-performance-tuning', title: 'Kafka性能调优', level: 'Expert', tags: ['批量发送', '压缩算法', '零拷贝', '页缓存', '顺序写', '参数调优'], difficulty: 5, category: 'kafka', prerequisites: ['kafka-architecture'], relatedPatterns: ['performance-tuning', 'high-throughput'], readingTime: 60 } },
            ],
          },
          {
            id: 'rocketmq',
            ...
            color: 'indigo',
            articles: [
              { slug: 'rocketmq-architecture', title: 'RocketMQ架构设计', meta: { id: 'rocketmq-architecture', title: 'RocketMQ架构设计', level: 'Expert', tags: ['RocketMQ', 'NameServer', 'Broker', 'Producer', 'Consumer', 'CommitLog', 'ConsumeQueue'], difficulty: 4, category: 'rocketmq', prerequisites: [], relatedPatterns: ['kafka-architecture', 'distributed-systems'], readingTime: 60 } },
              { slug: 'rocketmq-transaction', title: 'RocketMQ事务消息', meta: { id: 'rocketmq-transaction', title: 'RocketMQ事务消息', level: 'Expert', tags: ['事务消息', '半消息', '回查机制', '最终一致性', '分布式事务'], difficulty: 5, category: 'rocketmq', prerequisites: ['rocketmq-architecture'], relatedPatterns: ['distributed-transaction', 'message-reliability'], readingTime: 65 } },
              { slug: 'rocketmq-advanced', title: 'RocketMQ高级特性', meta: { id: 'rocketmq-advanced', title: 'RocketMQ高级特性', level: 'Expert', tags: ['顺序消息', '延迟消息', '批量消息', '消息过滤', '重试机制', '死信队列'], difficulty: 4, category: 'rocketmq', prerequisites: ['rocketmq-architecture'], relatedPatterns: ['message-patterns', 'error-handling'], readingTime: 55 } },
              { slug: 'rocketmq-ha', title: 'RocketMQ高可用与容灾', meta: { id: 'rocketmq-ha', title: 'RocketMQ高可用与容灾', level: 'Expert', tags: ['主从同步', 'DLedger', '多副本', '故障切换', '数据恢复', '双主双从'], difficulty: 5, category: 'rocketmq', prerequisites: ['rocketmq-architecture'], relatedPatterns: ['high-availability', 'disaster-recovery'], readingTime: 60 } },
            ],
          },
          {
            id: 'rabbitmq',
            ...
            color: 'teal',
            articles: [
              { slug: 'rabbitmq-core', title: 'RabbitMQ核心概念', meta: { id: 'rabbitmq-core', title: 'RabbitMQ核心概念', level: 'Senior', tags: ['RabbitMQ', 'AMQP', 'Exchange', 'Queue', 'Binding', 'Routing Key', 'Virtual Host'], difficulty: 3, category: 'rabbitmq', prerequisites: [], relatedPatterns: ['message-queue', 'protocol-design'], readingTime: 50 } },
              { slug: 'rabbitmq-routing', title: 'RabbitMQ路由模式', meta: { id: 'rabbitmq-routing', title: 'RabbitMQ路由模式', level: 'Senior', tags: ['Direct', 'Fanout', 'Topic', 'Headers', '路由策略', '消息分发'], difficulty: 4, category: 'rabbitmq', prerequisites: ['rabbitmq-core'], relatedPatterns: ['message-patterns', 'event-driven'], readingTime: 55 } },
              { slug: 'rabbitmq-reliability', title: 'RabbitMQ消息可靠性', meta: { id: 'rabbitmq-reliability', title: 'RabbitMQ消息可靠性', level: 'Expert', tags: ['持久化', 'ACK机制', '镜像队列', '事务', 'Confirm模式', '消息确认'], difficulty: 5, category: 'rabbitmq', prerequisites: ['rabbitmq-core'], relatedPatterns: ['message-reliability', 'high-availability'], readingTime: 60 } },
              { slug: 'rabbitmq-cluster', title: 'RabbitMQ集群与高可用', meta: { id: 'rabbitmq-cluster', title: 'RabbitMQ集群与高可用', level: 'Expert', tags: ['集群模式', '镜像队列', 'HaProxy', '负载均衡', '故障转移', '联邦队列'], difficulty: 5, category: 'rabbitmq', prerequisites: ['rabbitmq-core'], relatedPatterns: ['high-availability', 'load-balancing'], readingTime: 65 } },
            ],
          },
          {
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        estimatedHours: 30,
        nodes: [
          { chapterId: 'clickhouse', title: 'ClickHouse', icon: '⚡', readingTime: 190, difficulty: 5 },
          { chapterId: 'tidb', title: 'TiDB', icon: '🔶', readingTime: 195, difficulty: 5 },
        ],
      },
      {
        title: '消息通信',
      ...
      },
      {
        ...
        estimatedHours: 80,
        nodes: [
          { chapterId: 'bigdata-ecosystem', title: '大数据生态', icon: '📊', readingTime: 505, difficulty: 5 },
        ],
      },
      {
        title: '分布式系统',
