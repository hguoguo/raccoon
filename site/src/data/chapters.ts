...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      { slug: 'set-deep-dive', title: 'Set深度解析（HashSet/TreeSet）', meta: { id: 'set-deep-dive', title: 'Set深度解析（HashSet/TreeSet）', level: 'Expert', tags: ['Set', 'HashSet', 'TreeSet', '去重', '红黑树', 'hashCode'], difficulty: 4, category: '02-collections', prerequisites: ['collection-framework'], relatedPatterns: ['map-framework', 'hashmap-internals'], readingTime: 45 } },
      { slug: 'map-framework', title: 'Map框架（HashMap/TreeMap）', meta: { id: 'map-framework', title: 'Map框架（HashMap/TreeMap）', level: 'Expert', tags: ['Map', 'HashMap', 'TreeMap', '键值对', '红黑树', '哈希表'], difficulty: 4, category: '02-collections', prerequisites: ['collection-framework'], relatedPatterns: ['hashmap-internals', 'set-deep-dive'], readingTime: 50 } },
      ...
      { slug: 'hashmap-internals', title: 'HashMap底层原理（重点🔥）', meta: { id: 'hashmap-internals', title: 'HashMap底层原理（重点🔥）', level: 'Expert', tags: ['HashMap', '扰动函数', '高低位分流', '扩容', '线程安全', '死循环'], difficulty: 5, category: '02-collections', prerequisites: ['hashmap'], relatedPatterns: ['concurrent-hashmap'], readingTime: 60 } },
    ],
  },
