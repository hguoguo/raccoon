    ...
    subCategories: [
      {
        ...
        chapters: [
          ...
          },
          {
            ...
            color: 'blue',
            articles: [
              { slug: 'tidb-architecture', title: 'TiDB分布式HTAP数据库（未实现）', meta: { id: 'tidb-architecture', title: 'TiDB分布式HTAP数据库', level: 'Expert', tags: ['TiDB', 'HTAP', '分布式数据库', 'TiKV', 'TiFlash', 'NewSQL', 'MySQL兼容', '水平扩展'], difficulty: 5, category: 'tidb', prerequisites: ['mysql-architecture'], relatedPatterns: ['distributed-systems', 'high-availability', 'clickhouse-architecture'], readingTime: 70 } },
              { slug: 'tidb-optimization', title: 'TiDB性能调优与实践（未实现）', meta: { id: 'tidb-optimization', title: 'TiDB性能调优与实践', level: 'Expert', tags: ['TiDB', '执行计划', '索引优化', '统计信息', 'Region分裂', 'PD调度', 'TiFlash加速'], difficulty: 5, category: 'tidb', prerequisites: ['tidb-architecture'], relatedPatterns: ['performance-tuning', 'sql-optimization'], readingTime: 65 } },
              { slug: 'tidb-vs-mysql', title: 'TiDB vs MySQL：选型与迁移指南（未实现）', meta: { id: 'tidb-vs-mysql', title: 'TiDB vs MySQL：选型与迁移指南', level: 'Expert', tags: ['TiDB', 'MySQL', '技术选型', '数据库迁移', '分布式', '兼容性', '场景对比'], difficulty: 4, category: 'tidb', prerequisites: ['tidb-architecture', 'mysql-architecture'], relatedPatterns: ['database-comparison', 'high-availability'], readingTime: 60 } },
            ],
          },
          {
      ...
      },
      {
        ...
        chapters: [
          ...
          },
          {
            ...
            color: 'blue',
            articles: [
              { slug: 'elasticsearch', title: 'Elasticsearch搜索引擎（未实现）', meta: { id: 'elasticsearch', title: 'Elasticsearch搜索引擎', level: 'Senior', tags: ['Elasticsearch', '全文检索', '倒排索引', 'Lucene', '聚合查询', 'ELK'], difficulty: 4, category: 'elasticsearch', prerequisites: [], relatedPatterns: ['vector-database', 'semantic-search-optimization'], readingTime: 60 } },
            ],
          },
        ],
      },
        ...
        chapters: [
          {
            ...
            color: 'blue',
            articles: [
              { slug: 'flink-streaming', title: 'Flink实时计算框架（未实现）', meta: { id: 'flink-streaming', title: 'Flink实时计算框架', level: 'Expert', tags: ['Flink', '流处理', 'DataStream API', 'Checkpoint', '状态管理', '窗口', 'Watermark'], difficulty: 5, category: 'bigdata-ecosystem', prerequisites: ['java-basics', 'multi-threading-basics'], relatedPatterns: ['spark-computing', 'kafka'], readingTime: 70 } },
              { slug: 'spark-computing', title: 'Spark分布式计算（未实现）', meta: { id: 'spark-computing', title: 'Spark分布式计算', level: 'Expert', tags: ['Spark', 'RDD', 'DataFrame', 'Spark SQL', 'MLlib', 'GraphX', '分布式计算'], difficulty: 5, category: 'bigdata-ecosystem', prerequisites: ['java-basics', 'python-basics'], relatedPatterns: ['flink-streaming', 'hadoop-ecosystem'], readingTime: 65 } },
              { slug: 'hadoop-ecosystem', title: 'Hadoop生态系统（未实现）', meta: { id: 'hadoop-ecosystem', title: 'Hadoop生态系统', level: 'Senior', tags: ['Hadoop', 'MapReduce', 'YARN', 'HDFS', '生态圈', '大数据平台'], difficulty: 4, category: 'bigdata-ecosystem', prerequisites: ['java-basics'], relatedPatterns: ['hdfs', 'hive-data-warehouse'], readingTime: 60 } },
              { slug: 'hive-data-warehouse', title: 'Hive数据仓库（未实现）', meta: { id: 'hive-data-warehouse', title: 'Hive数据仓库', level: 'Senior', tags: ['Hive', 'HQL', '数据仓库', '分区表', '分桶表', 'UDF', '优化'], difficulty: 4, category: 'bigdata-ecosystem', prerequisites: ['sql-optimization'], relatedPatterns: ['hadoop-ecosystem', 'elasticsearch'], readingTime: 55 } },
              { slug: 'hdfs', title: 'HDFS分布式文件系统（未实现）', meta: { id: 'hdfs', title: 'HDFS分布式文件系统', level: 'Senior', tags: ['HDFS', 'NameNode', 'DataNode', '副本机制', '块存储', '高可用'], difficulty: 4, category: 'bigdata-ecosystem', prerequisites: ['hadoop-ecosystem'], relatedPatterns: ['distributed-systems', 'storage'], readingTime: 50 } },
              { slug: 'realtime-data-warehouse', title: '实时数仓架构设计（未实现）', meta: { id: 'realtime-data-warehouse', title: '实时数仓架构设计', level: 'Expert', tags: ['实时数仓', 'Lambda架构', 'Kappa架构', '流批一体', '数据湖', 'Iceberg'], difficulty: 5, category: 'bigdata-ecosystem', prerequisites: ['flink-streaming', 'hive-data-warehouse'], relatedPatterns: ['stream-batch-unified', 'data-lake'], readingTime: 70 } },
              { slug: 'stream-batch-unified', title: '流批一体处理（未实现）', meta: { id: 'stream-batch-unified', title: '流批一体处理', level: 'Expert', tags: ['流批一体', '统一API', 'Flink SQL', '数据一致性', 'Exactly-Once'], difficulty: 5, category: 'bigdata-ecosystem', prerequisites: ['flink-streaming', 'spark-computing'], relatedPatterns: ['realtime-data-warehouse', 'data-pipeline'], readingTime: 65 } },
            ],
          },
        ],
      },
