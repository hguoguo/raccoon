        ...
        chapters: [
          {
            ...
            articles: [
              ...
              { slug: 'primitive-types', title: '基本数据类型与包装类（未实现）', meta: { id: 'primitive-types', title: '基本数据类型与包装类', level: 'Junior', tags: ['基本类型', '包装类', '自动装箱', '自动拆箱', 'Integer缓存', '类型转换'], difficulty: 2, category: '01-java-core', prerequisites: ['java-basics'], relatedPatterns: ['string-deep-dive'], readingTime: 40 } },
              ...
              { slug: 'proxy-pattern', title: '代理模式详解（未实现）', meta: { id: 'proxy-pattern', title: '代理模式详解', level: 'Senior', tags: ['代理模式', 'JDK动态代理', 'CGLIB', '静态代理', 'AOP基础', 'InvocationHandler'], difficulty: 4, category: '01-java-core', prerequisites: ['reflection'], relatedPatterns: ['spring-aop', 'structural-patterns'], readingTime: 50 } },
          ...
          },
          {
            ...
            articles: [
              ...
              { slug: 'jmm-deep-dive', title: 'Java内存模型（JMM）深度解析（未实现）', meta: { id: 'jmm-deep-dive', title: 'Java内存模型（JMM）深度解析', level: 'Expert', tags: ['JMM', 'happens-before', '内存屏障', '重排序', '工作内存', '主内存', 'volatile语义'], difficulty: 5, category: '03-multithreading', prerequisites: ['multi-threading-basics'], relatedPatterns: ['jvm-memory-model', 'atomic-operations'], readingTime: 65 } },
              ...
              { slug: 'lock-mechanism', title: 'Java锁机制深入剖析（未实现）', meta: { id: 'lock-mechanism', title: 'Java锁机制深入剖析', level: 'Expert', tags: ['偏向锁', '轻量级锁', '重量级锁', '锁升级', '自旋锁', '适应性自旋', '锁消除', '锁粗化'], difficulty: 5, category: '03-multithreading', prerequisites: ['synchronization'], relatedPatterns: ['jmm-deep-dive', 'aqs-principle'], readingTime: 70 } },
              ...
              { slug: 'aqs-principle', title: 'AQS原理剖析（未实现）', meta: { id: 'aqs-principle', title: 'AQS原理剖析', level: 'Expert', tags: ['AQS', 'AbstractQueuedSynchronizer', 'CLH队列', '独占模式', '共享模式', 'ReentrantLock实现'], difficulty: 5, category: '03-multithreading', prerequisites: ['lock-mechanism'], relatedPatterns: ['concurrent-utils', 'thread-pool'], readingTime: 70 } },
              ...
              { slug: 'threadlocal', title: 'ThreadLocal详解（未实现）', meta: { id: 'threadlocal', title: 'ThreadLocal详解', level: 'Senior', tags: ['ThreadLocal', '线程隔离', '内存泄漏', '弱引用', 'InheritableThreadLocal', 'TransmittableThreadLocal'], difficulty: 4, category: '03-multithreading', prerequisites: ['multi-threading-basics'], relatedPatterns: ['jmm-deep-dive', 'spring-transaction'], readingTime: 50 } },
              { slug: 'completable-future', title: 'CompletableFuture异步编程（未实现）', meta: { id: 'completable-future', title: 'CompletableFuture异步编程', level: 'Senior', tags: ['CompletableFuture', '异步编程', 'thenApply', 'thenCompose', 'allOf', 'anyOf', '异常处理'], difficulty: 4, category: '03-multithreading', prerequisites: ['lambda-expressions'], relatedPatterns: ['thread-pool', 'reactive-programming'], readingTime: 55 } },
          ...
          },
          {
            ...
            articles: [
              ...
              { slug: 'cicd', title: 'CI/CD持续集成部署（未实现）', meta: { id: 'cicd', title: 'CI/CD持续集成部署', level: 'Senior', tags: ['Jenkins', 'GitLab CI', 'GitHub Actions', 'Docker', 'Kubernetes', '流水线', '自动化测试', '蓝绿部署'], difficulty: 4, category: '11-build-tools', prerequisites: ['maven', 'project-structure'], relatedPatterns: ['docker', 'microservices'], readingTime: 50 } },
            ],
          },
          {
            id: '12-java-security',
        ...
        chapters: [
          {
            ...
            color: 'orange',
            articles: [
              { slug: 'python-basics', title: 'Python基础语法（未实现）', meta: { id: 'python-basics', title: 'Python基础语法', level: 'Junior', tags: ['Python', '基础语法', '变量', '数据类型', '函数', '类'], difficulty: 1, category: '01-python-basics', prerequisites: [], relatedPatterns: ['python-oop', 'python-modules'], readingTime: 45 } },
              { slug: 'pydantic', title: 'Pydantic 数据验证（未实现）', meta: { id: 'pydantic', title: 'Pydantic 数据验证', level: 'Senior', tags: ['Pydantic', 'BaseModel', '数据验证', 'JSON Schema', '序列化'], difficulty: 3, category: '01-python-basics', prerequisites: ['python-basics', 'python-typing'], relatedPatterns: ['fastapi', 'data-validation'], readingTime: 40 } },
              { slug: 'python-async', title: 'Python 异步编程（未实现）', meta: { id: 'python-async', title: 'Python 异步编程', level: 'Senior', tags: ['async', 'await', 'asyncio', '协程', '并发', 'aiohttp', 'httpx'], difficulty: 4, category: '01-python-basics', prerequisites: ['python-basics', 'python-functions'], relatedPatterns: ['fastapi', 'concurrent-programming'], readingTime: 50 } },
              { slug: 'fastapi', title: 'FastAPI 框架深度解析（未实现）', meta: { id: 'fastapi', title: 'FastAPI 框架深度解析', level: 'Senior', tags: ['FastAPI', '路由', '请求参数', '响应', '文件上传', '中间件', 'OpenAPI', 'Streaming', 'SSE', 'WebSocket'], difficulty: 4, category: '01-python-basics', prerequisites: ['python-async', 'pydantic'], relatedPatterns: ['uvicorn', 'starlette', 'sqlmodel'], readingTime: 55 } },
              { slug: 'python-engineering', title: 'Python 工程化实践（未实现）', meta: { id: 'python-engineering', title: 'Python 工程化实践', level: 'Senior', tags: ['pip', 'uv', '虚拟环境', '日志', 'dotenv', 'yaml', 'pytest', '工程化'], difficulty: 3, category: '01-python-basics', prerequisites: ['python-basics', 'python-modules'], relatedPatterns: ['fastapi', 'project-structure', 'ci-cd'], readingTime: 50 } },
            ],
          },
        ],
      },
        ...
        chapters: [
          {
            ...
            articles: [
              ...
              { slug: 'prompt-engineering', title: 'Prompt 工程（未实现）', meta: { id: 'prompt-engineering', title: 'Prompt 工程', level: 'Junior', tags: ['Prompt', 'System Prompt', 'Few-shot', 'Chain of Thought', 'ReAct', 'Prompt Template'], difficulty: 2, category: '06-ai-theory', prerequisites: ['llm-basics'], relatedPatterns: ['structured-output', 'llm-basics'], readingTime: 45 } },
              { slug: 'structured-output', title: '结构化输出（未实现）', meta: { id: 'structured-output', title: '结构化输出', level: 'Senior', tags: ['JSON', 'Schema', 'Pydantic', 'Output Parser', 'Validation', 'Structured Data'], difficulty: 3, category: '06-ai-theory', prerequisites: ['llm-basics', 'prompt-engineering'], relatedPatterns: ['pydantic', 'fastapi'], readingTime: 50 } },
              { slug: 'function-calling', title: 'Function Calling（未实现）', meta: { id: 'function-calling', title: 'Function Calling', level: 'Senior', tags: ['Function Calling', 'Tool Calling', 'JSON Schema', 'Tool Definition', 'Parameter Validation', 'Error Handling'], difficulty: 4, category: '06-ai-theory', prerequisites: ['llm-basics', 'prompt-engineering', 'structured-output'], relatedPatterns: ['structured-output', 'react-agent'], readingTime: 55 } },
              { slug: 'openai-sdk', title: 'OpenAI SDK（未实现）', meta: { id: 'openai-sdk', title: 'OpenAI SDK', level: 'Senior', tags: ['OpenAI', 'Chat API', 'Streaming', 'Function Calling', 'Embedding', 'Structured Output', 'Python SDK'], difficulty: 3, category: '06-ai-theory', prerequisites: ['llm-basics', 'prompt-engineering', 'structured-output'], relatedPatterns: ['function-calling', 'fastapi'], readingTime: 50 } },
            ],
          },
          {
            id: '07-ai-frameworks',
            ...
            articles: [
              ...
              { slug: 'workflow-design', title: 'Workflow 工作流设计（未实现）', meta: { id: 'workflow-design', title: 'Workflow 工作流设计', level: 'Expert', tags: ['Workflow', 'DAG', '状态机', 'Retry', 'Timeout', '并发执行', '持久化'], difficulty: 5, category: '07-ai-frameworks', prerequisites: ['langgraph-core', 'agent-patterns'], relatedPatterns: ['langchain-advanced'], readingTime: 50 } },
            ],
          },
          {
            ...
            color: 'purple',
            articles: [
              { slug: 'rag-introduction', title: 'RAG 基础概念（未实现）', meta: { id: 'rag-introduction', title: 'RAG 基础概念', level: 'Senior', tags: ['RAG', 'Retrieval', 'Augmented Generation', 'Vector Database', 'Embedding', 'Similarity Search'], difficulty: 3, category: '08-ai-applications', prerequisites: ['llm-basics', 'structured-output'], relatedPatterns: ['vector-database', 'embedding-models'], readingTime: 45 } },
              { slug: 'vector-database', title: '向量数据库（未实现）', meta: { id: 'vector-database', title: '向量数据库', level: 'Senior', tags: ['Vector DB', 'Chroma', 'Pinecone', 'Milvus', 'FAISS', '索引优化', '相似度计算'], difficulty: 4, category: '08-ai-applications', prerequisites: ['rag-introduction'], relatedPatterns: ['embedding-models', 'search-algorithms'], readingTime: 50 } },
              { slug: 'embedding-models', title: '嵌入模型（未实现）', meta: { id: 'embedding-models', title: '嵌入模型', level: 'Senior', tags: ['Embedding', 'Sentence Transformers', 'BGE', 'Text Embedding', '相似度匹配', '语义搜索'], difficulty: 4, category: '08-ai-applications', prerequisites: ['rag-introduction'], relatedPatterns: ['vector-database', 'llm-basics'], readingTime: 40 } },
              { slug: 'document-processing', title: '文档处理与切分（未实现）', meta: { id: 'document-processing', title: '文档处理与切分', level: 'Senior', tags: ['Document Loader', 'Text Splitter', 'Chunking Strategy', 'Metadata', 'PDF Processing', 'OCR'], difficulty: 4, category: '08-ai-applications', prerequisites: ['rag-introduction'], relatedPatterns: ['vector-database', 'data-pipeline'], readingTime: 45 } },
              { slug: 'retrieval-optimization', title: '检索优化策略（未实现）', meta: { id: 'retrieval-optimization', title: '检索优化策略', level: 'Expert', tags: ['Hybrid Search', 'Re-ranking', 'Query Expansion', 'Multi-query', 'Self-query', '检索调优'], difficulty: 5, category: '08-ai-applications', prerequisites: ['vector-database', 'embedding-models'], relatedPatterns: ['rag-evaluation', 'performance-tuning'], readingTime: 55 } },
              { slug: 'agent-architecture', title: 'Agent 架构设计（未实现）', meta: { id: 'agent-architecture', title: 'Agent 架构设计', level: 'Expert', tags: ['Agent Architecture', 'Planning', 'Memory', 'Tools', 'Reflection', 'Multi-Agent'], difficulty: 5, category: '08-ai-applications', prerequisites: ['agent-patterns', 'langgraph-core'], relatedPatterns: ['workflow-design', 'tool-integration'], readingTime: 60 } },
              { slug: 'tool-integration', title: '工具集成与调用（未实现）', meta: { id: 'tool-integration', title: '工具集成与调用', level: 'Senior', tags: ['Tool Integration', 'API Calling', 'Custom Tools', 'Tool Selection', 'Error Handling', 'Rate Limiting'], difficulty: 4, category: '08-ai-applications', prerequisites: ['function-calling', 'agent-patterns'], relatedPatterns: ['agent-architecture', 'api-design'], readingTime: 50 } },
              { slug: 'memory-management', title: '记忆管理（未实现）', meta: { id: 'memory-management', title: '记忆管理', level: 'Senior', tags: ['Short-term Memory', 'Long-term Memory', 'Conversation History', 'Knowledge Graph', 'Vector Store Memory'], difficulty: 4, category: '08-ai-applications', prerequisites: ['agent-patterns'], relatedPatterns: ['agent-architecture', 'state-management'], readingTime: 45 } },
              { slug: 'multi-agent-systems', title: '多智能体系统（未实现）', meta: { id: 'multi-agent-systems', title: '多智能体系统', level: 'Expert', tags: ['Multi-Agent', 'Agent Collaboration', 'Task Decomposition', 'Coordination', 'Communication Protocol'], difficulty: 5, category: '08-ai-applications', prerequisites: ['agent-architecture'], relatedPatterns: ['distributed-systems', 'workflow-design'], readingTime: 65 } },
            ],
          },
          {
            ...
            color: 'rose',
            articles: [
              { slug: 'model-finetuning', title: '模型微调与训练（未实现）', meta: { id: 'model-finetuning', title: '模型微调与训练', level: 'Expert', tags: ['Fine-tuning', 'LoRA', 'QLoRA', 'PEFT', '指令微调', 'RLHF', 'DPO', '训练数据'], difficulty: 5, category: '09-ai-engineering', prerequisites: ['llm-basics', 'python-async'], relatedPatterns: ['llm-quantization-deployment', 'pytorch'], readingTime: 70 } },
              { slug: 'ai-coding-workflow', title: 'AI Coding实践与工作流（未实现）', meta: { id: 'ai-coding-workflow', title: 'AI Coding实践与工作流', level: 'Senior', tags: ['AI Coding', 'Cursor', 'Copilot', '代码生成', '代码审查', '自动化测试', '工作流'], difficulty: 4, category: '09-ai-engineering', prerequisites: ['python-async'], relatedPatterns: ['cursor-ai-editor', 'github-copilot', 'claude-code'], readingTime: 55 } },
              { slug: 'canary-deployment', title: '金丝雀灰度发布策略（未实现）', meta: { id: 'canary-deployment', title: '金丝雀灰度发布策略', level: 'Expert', tags: ['Canary', '灰度发布', 'A/B测试', '流量分割', '回滚策略', 'Kubernetes', 'Istio'], difficulty: 5, category: '09-ai-engineering', prerequisites: ['cicd'], relatedPatterns: ['microservices', 'observability-monitoring'], readingTime: 60 } },
              { slug: 'observability-monitoring', title: '全链路监控告警体系（未实现）', meta: { id: 'observability-monitoring', title: '全链路监控告警体系', level: 'Expert', tags: ['Prometheus', 'Grafana', 'AlertManager', '日志聚合', '指标监控', '链路追踪', '可观测性'], difficulty: 5, category: '09-ai-engineering', prerequisites: ['distributed-tracing'], relatedPatterns: ['logging', 'performance-tuning'], readingTime: 65 } },
            ],
          },
          {
            id: '10-llm-advanced',
            ...
            color: 'indigo',
            articles: [
              { slug: 'llamaindex-framework', title: 'LlamaIndex框架深度解析（未实现）', meta: { id: 'llamaindex-framework', title: 'LlamaIndex框架深度解析', level: 'Senior', tags: ['LlamaIndex', 'Data Connector', 'Index', 'Query Engine', 'Retriever', 'Node Parser'], difficulty: 4, category: '10-llm-advanced', prerequisites: ['langchain-basics', 'rag-introduction'], relatedPatterns: ['vector-database', 'document-processing'], readingTime: 60 } },
              { slug: 'multi-agent-collaboration', title: 'Multi-Agent多智能体协作架构（未实现）', meta: { id: 'multi-agent-collaboration', title: 'Multi-Agent多智能体协作架构', level: 'Expert', tags: ['Multi-Agent', '协作架构', '任务分解', '智能体通信', '协调机制', '分布式决策'], difficulty: 5, category: '10-llm-advanced', prerequisites: ['multi-agent-systems', 'agent-architecture'], relatedPatterns: ['autogen-framework', 'crewai-framework'], readingTime: 65 } },
              { slug: 'api-plugin-development', title: 'API插件开发与设计模式（未实现）', meta: { id: 'api-plugin-development', title: 'API插件开发与设计模式', level: 'Senior', tags: ['API插件', 'Plugin', 'OpenAPI', '函数调用', '设计模式', '接口规范'], difficulty: 4, category: '10-llm-advanced', prerequisites: ['function-calling', 'restful-api'], relatedPatterns: ['tool-integration', 'api-design'], readingTime: 50 } },
              { slug: 'llm-quantization-deployment', title: '大模型轻量化部署与量化推理（未实现）', meta: { id: 'llm-quantization-deployment', title: '大模型轻量化部署与量化推理', level: 'Expert', tags: ['量化', 'INT8', 'INT4', 'GGUF', 'AWQ', 'vLLM', 'TensorRT', '推理优化'], difficulty: 5, category: '10-llm-advanced', prerequisites: ['llm-basics'], relatedPatterns: ['model-finetuning', 'performance-tuning'], readingTime: 70 } },
              { slug: 'document-structure-extraction', title: '文档结构化处理与布局分析（未实现）', meta: { id: 'document-structure-extraction', title: '文档结构化处理与布局分析', level: 'Senior', tags: ['文档解析', '布局分析', '表格提取', '版面识别', 'Unstructured', 'LayoutLM'], difficulty: 4, category: '10-llm-advanced', prerequisites: ['document-processing'], relatedPatterns: ['ocr-ai-integration', 'content-extraction'], readingTime: 55 } },
              { slug: 'ocr-ai-integration', title: 'OCR+AI智能文档识别（未实现）', meta: { id: 'ocr-ai-integration', title: 'OCR+AI智能文档识别', level: 'Senior', tags: ['OCR', 'PaddleOCR', 'Tesseract', '文本识别', '图像预处理', '后处理'], difficulty: 4, category: '10-llm-advanced', prerequisites: ['document-processing'], relatedPatterns: ['document-structure-extraction', 'content-extraction'], readingTime: 50 } },
              { slug: 'semantic-search-optimization', title: '语义检索优化策略（未实现）', meta: { id: 'semantic-search-optimization', title: '语义检索优化策略', level: 'Expert', tags: ['语义检索', '混合搜索', '重排序', '查询扩展', 'BM25', '向量检索'], difficulty: 5, category: '10-llm-advanced', prerequisites: ['retrieval-optimization', 'embedding-models'], relatedPatterns: ['vector-database', 'rag-introduction'], readingTime: 60 } },
              { slug: 'content-extraction', title: '内容抽取与信息提取（未实现）', meta: { id: 'content-extraction', title: '内容抽取与信息提取', level: 'Senior', tags: ['信息抽取', 'NER', '关系抽取', '事件抽取', '知识图谱', 'IE'], difficulty: 4, category: '10-llm-advanced', prerequisites: ['structured-output'], relatedPatterns: ['document-structure-extraction', 'knowledge-graph'], readingTime: 50 } },
              { slug: 'dify-platform', title: 'Dify低代码AI应用平台（未实现）', meta: { id: 'dify-platform', title: 'Dify低代码AI应用平台', level: 'Senior', tags: ['Dify', '低代码', '可视化编排', '工作流', '应用部署', 'LLMOps'], difficulty: 3, category: '10-llm-advanced', prerequisites: ['langchain-basics'], relatedPatterns: ['workflow-design', 'agent-patterns'], readingTime: 45 } },
              { slug: 'mcp-protocol', title: 'MCP协议与上下文管理（未实现）', meta: { id: 'mcp-protocol', title: 'MCP协议与上下文管理', level: 'Expert', tags: ['MCP', 'Model Context Protocol', '上下文管理', '资源访问', '工具协议', '标准化'], difficulty: 5, category: '10-llm-advanced', prerequisites: ['agent-architecture'], relatedPatterns: ['mcp-server-development', 'tool-integration'], readingTime: 55 } },
              { slug: 'mcp-server-development', title: 'MCP Server开发与集成（未实现）', meta: { id: 'mcp-server-development', title: 'MCP Server开发与集成', level: 'Expert', tags: ['MCP Server', '服务器开发', '协议实现', 'SDK', '集成测试', '最佳实践'], difficulty: 5, category: '10-llm-advanced', prerequisites: ['mcp-protocol'], relatedPatterns: ['api-plugin-development', 'tool-integration'], readingTime: 60 } },
              { slug: 'multimodal-agent', title: '多模态Agent架构设计（未实现）', meta: { id: 'multimodal-agent', title: '多模态Agent架构设计', level: 'Expert', tags: ['多模态', '视觉理解', '语音交互', '图像处理', 'GPT-4V', 'CLIP'], difficulty: 5, category: '10-llm-advanced', prerequisites: ['agent-architecture'], relatedPatterns: ['ocr-ai-integration', 'multi-agent-systems'], readingTime: 65 } },
            ],
          },
          {
