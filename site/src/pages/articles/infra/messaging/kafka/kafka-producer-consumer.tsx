...
producer.send(record);`}
          ...
          <Callout type="tip" title="批量发送优化建议">
            <p className="text-[14px] sm:text-[15px] leading-[1.8]">
...
{`consumer.commitAsync((offsets, exception) -> {
    if (exception != null) {
        log.error("Commit failed for offsets {}", offsets, exception);
          ...
          <Callout type="danger" title="Rebalance 风暴">
            <p className="text-[14px] sm:text-[15px] leading-[1.8]">
          ...
          <Callout type="danger" title="误区 1：Consumer 线程越多越好">
            <p className="text-[14px] sm:text-[15px] leading-[1.8]">
          ...
          <Callout type="danger" title="误区 2：acks=1 就足够可靠">
            <p className="text-[14px] sm:text-[15px] leading-[1.8]">
          ...
          <Callout type="danger" title="误区 3：自动提交 Offset 最简单">
            <p className="text-[14px] sm:text-[15px] leading-[1.8]">
          ...
          <InterviewSection
            questions={[
              ...
              {
                question: 'Kafka Consumer 的 Pull 模式相比 Push 模式有什么优势？',
